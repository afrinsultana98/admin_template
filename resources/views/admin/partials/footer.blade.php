            ...
            <div class="col-sm-6 ms-auto my-1">
                <ul class="list-inline footer-link mb-0 justify-content-sm-end d-flex">
                    <li class="list-inline-item"><a
                            href="https://codedthemes.com/demos/admin-templates/gradient-able/bootstrap/default/index.html">Home</a>
                    </li>
                    <li class="list-inline-item"><a
                            href="https://codedthemes.gitbook.io/gradient-able-bootstrap/"
            ...
            <ul class="list-group list-group-flush">
                        ...
                        <div class="col-6">
                            <div class="d-grid">
                                <button class="preset-btn btn" data-value="true"
                                    onclick="if (!window.__cfRLUnblockHandlers) return false; layout_sidebar_change('dark');"
                                    data-cf-modified-90f9e57eb6fda3c0ef534197->
                                    <span class="btn-label">Dark</span>
                                    <span
                                        class="pc-lay-icon"><span></span><span></span><span></span><span></span></span>
                        ...
                        <div class="col-6">
                            <div class="d-grid">
                                <button class="preset-btn btn active" data-value="false"
                                    onclick="if (!window.__cfRLUnblockHandlers) return false; layout_sidebar_change('light');"
                                    data-cf-modified-90f9e57eb6fda3c0ef534197->
                                    <span class="btn-label">Light</span>
                                    <span
                                        class="pc-lay-icon"><span></span><span></span><span></span><span></span></span>
                ...
                <li class="list-group-item">
                    ...
                    <div class="theme-color header-color">
                        <a href="#!" class="active" data-value="header-1"><i
                ...
                <li class="list-group-item">
                    ...
                    <div class="row theme-color theme-nav-caption">
                        <div class="col-6">
                            <div class="d-grid">
                                <button class="preset-btn btn active" data-value="true"
                                    onclick="if (!window.__cfRLUnblockHandlers) return false; layout_caption_change('true');"
                                    data-cf-modified-90f9e57eb6fda3c0ef534197->
                        ...
                        <div class="col-6">
                            <div class="d-grid">
                                <button class="preset-btn btn" data-value="false"
                                    onclick="if (!window.__cfRLUnblockHandlers) return false; layout_caption_change('false');"
                                    data-cf-modified-90f9e57eb6fda3c0ef534197->
                    ...
                    <div class="pc-rtl">
                        ...
                        <div class="row theme-color theme-direction">
                            <div class="col-6">
                                <div class="d-grid">
                                    <button class="preset-btn btn active" data-value="false"
                                        onclick="if (!window.__cfRLUnblockHandlers) return false; layout_rtl_change('false');"
                                        data-cf-modified-90f9e57eb6fda3c0ef534197->
                            ...
                            <div class="col-6">
                                <div class="d-grid">
                                    <button class="preset-btn btn" data-value="true"
                                        onclick="if (!window.__cfRLUnblockHandlers) return false; layout_rtl_change('true');"
                                        data-cf-modified-90f9e57eb6fda3c0ef534197->
                    ...
                    <div class="pc-container-width">
                        ...
                        <div class="row theme-color theme-container">
                            <div class="col-6">
                                <div class="d-grid">
                                    <button class="preset-btn btn active" data-value="false"
                                        onclick="if (!window.__cfRLUnblockHandlers) return false; change_box_container('false')"
                                        data-cf-modified-90f9e57eb6fda3c0ef534197->
                            ...
                            <div class="col-6">
                                <div class="d-grid">
                                    <button class="preset-btn btn" data-value="true"
                                        onclick="if (!window.__cfRLUnblockHandlers) return false; change_box_container('true')"
                                        data-cf-modified-90f9e57eb6fda3c0ef534197->
